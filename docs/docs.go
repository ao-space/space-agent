    ...
    "paths": {
        ...
        "/agent/v1/api/device/netconfig": {
            ...
            "post": {
                ...
                "summary": "set Wi-Fi password [for gateway]",
                "operationId": "PairNetNetConfigSettingDevice",
                "parameters": [
                    {
                        "description": "Wi-Fi ssid and password.",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pair.WifiPwdReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "code=AG-200 success; code=AG-561 connect failed",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/dto.BaseRspStr"
                                },
                                {
                                    ...
                                    "properties": {
                                        "results": {
                                            "$ref": "#/definitions/pair.WifiStatusRsp"
                                        }
                                    }
                                }
                            ]
        ...
        "/agent/v1/api/pair/net/netconfig": {
            ...
            "post": {
                ...
                "summary": "set Wi-Fi password [for client]",
                "operationId": "PairNetNetConfigSetting",
                "parameters": [
                    {
                        "description": "Wi-Fi ssid and password.",
                        "name": "req",
