...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "results": {
                                            "$ref": "#/definitions/agent_biz_web_handler_bind_internet_service_config.GetConfigRsp"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/agent_biz_web_handler_bind_internet_service_config.ConfigReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "results": {
                                            "$ref": "#/definitions/agent_biz_web_handler_bind_internet_service_config.ConfigRsp"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        "agent_biz_model_upgrade.VersionDownInfo": {
            "type": "object",
            "properties": {
                "downloaded": {
                    "type": "boolean"
        ...
        "agent_biz_web_handler_bind_internet_service_config.ConfigReq": {
            "type": "object",
            "properties": {
                "clientUUID": {
                    "type": "string"
        ...
        "agent_biz_web_handler_bind_internet_service_config.ConfigRsp": {
            "type": "object",
            "properties": {
                "connectedNetwork": {
                    "type": "array",
        ...
        "agent_biz_web_handler_bind_internet_service_config.GetConfigRsp": {
            "type": "object",
            "properties": {
                "connectedNetwork": {
                    "type": "array",
        ...
        "upgrade.Task": {
            ...
            "properties": {
                "KernelImg": {
                    "$ref": "#/definitions/agent_biz_model_upgrade.VersionDownInfo"
                },
                "cFile": {
